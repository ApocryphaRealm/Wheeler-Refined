...
#define MAP_ENTRY(textTypeName, defaultText) \
	...
	static inline std::unordered_map<TextType, std::string> _textData = {
		...
		MAP_ENTRY(EditHintActionUsePlaceItem, "Add"),
		MAP_ENTRY(EditHintActionRemoveItemWheel, "Remove"),
		...
		MAP_ENTRY(EditHintActionPickUpSlot, "Pick Up / Drop Slot"),
		MAP_ENTRY(FavoriteAddedToSlot, "added to wheel slot"),
		MAP_ENTRY(FavoriteSlotFull, "That wheel slot is full"),
		MAP_ENTRY(WheelNameInventory, "Inventory Wheel"),
		MAP_ENTRY(WheelNameMagic, "Magic Wheel"),
		...
		MAP_ENTRY(EditHintActionRotateWheel, "Rotate Wheel"),
