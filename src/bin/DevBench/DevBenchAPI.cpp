...
// Include path differs from the upstream copy on purpose: Wheeler's include roots are `src` and
// the generated binary dir, and these two vendored files live at src/bin/DevBench/, so the path is
// rooted at `bin`. Everything else in this file is byte-identical to upstream.
